package org.gentrifiedApps.gentrifiedAppsUtil.controllers.driverAid
...
//    }
    ...
    class DAFunc<T : Enum<T>>(
        ...
        constructor(
            driverAid: DriverAid<T>,
            state: T,
            funcs: Runnable,
            runConstant: Runnable,
            isEnded: BooleanSupplier
        ) : this(driverAid, state, funcs, runConstant, isEnded, null)
        ...
        constructor(
            ...
            funcs: Runnable,
            runConstant: Runnable
        ) : this(driverAid, state, funcs, runConstant, null, null)

        /**
         * IDLE constructor
         */
        constructor(driverAid: DriverAid<T>, state: T) : this(
            driverAid,
            state,
            Runnable {},
            Runnable {},
